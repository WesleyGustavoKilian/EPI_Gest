...
class _EditEmployeeDrawerState extends State<EditEmployeeDrawer>
  ...
  final _novoSetorController = TextEditingController();
  final _novaFuncaoController = TextEditingController();
  ...
  void initState() {
    ...
    // Inicializa controllers com os valores do funcionário
    ...
    _setorController = TextEditingController(text: widget.employee['setor']);
    _funcaoController = TextEditingController(text: widget.employee['funcao']);
    
    _selectedDate = widget.employee['dataEntrada'];
    ...
    if (widget.employee['imagem'] != null) {
      _imageFile = File(widget.employee['imagem']);
    }
